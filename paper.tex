...
RickView is an RDF browser that follows an alternative approach of directly querying an in-memory dataset bypassing SPARQL.
...
\begin{figure}
\includegraphics{img/relatedwork.pdf}
\caption{Source: \cite{adaptinglodview}.
